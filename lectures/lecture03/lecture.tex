...
\centerimage{kernel-datastructures.png}{Kernel structures}{0.5}
\centerimage{process-table.png}{Processes}{0.5}
\centerimage{file-table.png}{Files}{0.5}
\centerimage{vnode-table.png}{Vnode and Inode}{0.5}
\subsection{Duplication and sharing}
\centerimage{dup.png}{Duplication}{0.5}
\centerimage{file-sharing.png}{Sharing}{0.5}
