...
\centerimage{kernel-datastructures.png}{Kernel structures}{0.6}
...
\end{minipage}
\caption{Duplication and sharing}
\end{figure}
\subsection{Deep view}
\centerimage{process-table.png}{Processes}{0.39}
\centerimage{file-table.png}{Files}{0.39}
\centerimage{vnode-table.png}{Vnode and Inode}{0.39}
...
\section{Диски}
\centerimage{disk-mechanism.jpg}{Устройство диска}{0.8}
\begin{itemize}
    \item Устройство диска:
          \begin{itemize}
              \item сектор
                    \begin{itemize}
